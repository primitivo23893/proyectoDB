...
<body>
    <div class="top-bar">
        ...
        <div class="page-title">Consulta de Profesores - Usuario: <?php echo htmlspecialchars($usuario); ?></div>
    ...
    <div class="content">
        <div class="table-container">
            ...
            <div class="search-box">
                <input type="text" id="searchInput" class="search-input" placeholder="Buscar profesor...">
                ...
                <tbody>
                    <?php if (!empty($profesores)): ?>
                        <?php foreach ($profesores as $profesor): ?>
                            <tr>
                                <td><?php echo htmlspecialchars($profesor['codigo']); ?></td>
    ...
    <script>
        ...
        function searchTable() {
            ...
            table = document.getElementById("profesoresTable");
